...
trait FasternetCookieUsuarioTrait
{
    public function capturarCookiesUsuario()
    {
        ...
        $url = "http://www2.fasternet.com.br/fasteradm/blank.asp?usuariologin={$this->userAdm}&g={$this->cccCookie}";
